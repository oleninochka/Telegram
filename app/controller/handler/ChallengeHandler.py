...
class ChallengeHandler:
    ...
    @staticmethod
    async def toggle_solved(event: ChatEvent, checkbox: ManagedCheckboxAdapter, dialog_manager: DialogManager):
    ...
    @staticmethod
    def is_not_solved(data: Dict, widget: Whenable, manager: DialogManager):
